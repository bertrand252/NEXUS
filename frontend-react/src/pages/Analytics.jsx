  ...
  return (
    <>
      ...
      <div className="p-8 space-y-6">
        ...
        <div className="glow-border rounded-2xl bg-card border border-border p-5">
          <h3 className="text-sm font-bold text-white tracking-tight mb-1">NEXUS Win Rate</h3>
          <p className="text-[11px] text-slate-500 mb-4">Win rate real dari alert Telegram (TP vs SL), bukan asumsi</p>
